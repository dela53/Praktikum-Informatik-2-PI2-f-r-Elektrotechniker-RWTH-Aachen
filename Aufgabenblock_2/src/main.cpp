...
void vUhr()
{
	...
	cout << endl << endl << setw(21) << setfill('-') << "-" << setfill(' ') << endl;
	cout << "Globale-Zeit: " << dGlobaleZeit*60 << " min" << endl;
	cout << setw(21) << setfill('-') << "-" << setfill(' ') << endl << endl;
}
...
// Funktion die alle Fahrzeuge in der Liste zeichnet
void vZeichne(Weg& weg)
{
    for (auto& fahrzeug_ptr : weg.getFahrzeuge())
    {
        fahrzeug_ptr->vZeichnen(weg);
    }
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void vAufgabe_6()
{
	...
	auto fzg_fahrend = make_unique<PKW>("Mercedes", 220, 9.0);
	auto fzg_parkend = make_unique<PKW>("Mclaren", 225, 16.0);
	auto fzg2_fahrend = make_unique<Fahrrad>("BMX", 35);

	Weg stadt("Innenstadt", 500.0, INNERORTS); // Tempolimit: 50 kmh
	Weg a555("Autobahn", 500.0, AUTOBAHN); // Tempolimit: unbegrenzt
